...
headingFrame.place(relx=0.5, rely=0.05, relwidth=0.7, relheight=0.1)
headingLable = Label(headingFrame, text="Generate QR from Python", bg='azure', font=('Times',20,'bold'))
headingLable.place(relx=0, rely=0, relwidth=1, relheight=1)
...
button = Button(wn, text='Generate Code',font=('Courier',15,'normal')
